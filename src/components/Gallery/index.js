...
class GallaryApp extends Component {
  ...
  render() {
    ...
    return (
      <div className="GallaryApp-container">
        <div className="GallaryApp-card-container">
          <img
            src={imageUrl}
            alt={imageAltText}
            className="Selected-Gallary-image"
          />
          <h1 className="Gallary-heading">Nature Photography</h1>
          <p className="description">Nature Photography by Rahul</p>

          <ul className="GallaryApp-thumbnail-items">
            {imagesList.map(eachImage => (
              <ThumbnailItem
                key={eachImage.id}
                thumbnailItemDeatils={eachImage}
...
/*
  ...
  git config --global user.name Chetannaik-9535
   git remote add origin https://github.com/Chetannaik-9535/Gallery-App.git
*/
